...
var card5 = new Card('assets/bey3.jpeg');
var card6 = new Card('assets/bey3.jpeg');
...
function displayCards() {
  deck.cards.forEach(function(card) {
    sectionRight.insertAdjacentHTML('afterbegin',
    `<div class="card1 cards flip-container">
      <div class="flipper">
        <div class="front">
          <img src="${card.defaultImg}">
        </div>
        <div class="back">
          <img src="${card.selectedImg}">
        </div>
      </div>
    </div>`)
